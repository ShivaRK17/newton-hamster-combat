...
import noapp from './images/noapp.png'
import withapp from './images/withapp2.png'
...
const App = () => {
  ...
  return (
    <div className="bg-black flex justify-center">
      <audio ref={audioRef}>
        <source src={bonk} type="audio/mpeg" />
            ...
            <div className="px-4 mt-4 flex justify-center">
              ...
              >
                <div className="w-full h-full rounded-full circle-inner">
                  <img src={fell ? withapp : noapp} alt="Main Character" className="w-full h-full" />
                </div>
              </div>
            </div>
          </div>
